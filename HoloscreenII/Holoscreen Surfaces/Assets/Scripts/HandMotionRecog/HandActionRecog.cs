...
public class HandActionRecog : MonoBehaviour {
	...
	private void UpdateQueue() {
		...
		//HandActionItem rhai = new HandActionItem (RightHandGC.bufferedGesture (), currentTime, RightHandPalm.forward);
		...
		//if (HandActionItem.CompareTwoHandActionItem (rightHandList.Last.Value, rhai) > newItemDelta) {
	...
	public bool IsMotion (string motionName) {
		if (handMotionList.ContainsKey (motionName)) {
